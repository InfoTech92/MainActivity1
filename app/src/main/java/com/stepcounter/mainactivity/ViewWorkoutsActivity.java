...
public class ViewWorkoutsActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		while(dataEnd){
			...
			tempId 		= Integer.parseInt(trainingsCursor.getString(trainingsCursor.getColumnIndex("_id")));
			tempName 	= trainingsCursor.getString(trainingsCursor.getColumnIndex("name"));
			tempJson 	= trainingsCursor.getString(trainingsCursor.getColumnIndex("json"));
		...
		*/
		this.trainingListAdapter = new WorkoutListAdapter(this, ViewWorkoutsActivity.this, R.layout.workout_list_row, this.trainingArray);
